...
export { version, CaptureResult, msg, checkRootSelector, checkChild, DEFAULT_CAPTURE_KEY, DEFAULT_PROCEDURE_NAME, ASSIGN_PROCEDURE_NAME, UNIVERSAL_SELECTOR, defaultProcedureDict, defineProcedure, defaultFilterDict, defineFilter, defaultModifierDict, defineModifier, temmeParser, makeNormalCssSelector, isEmptyObject, isCheerioStatic, isAttributeQualifier, isCapture, last };
