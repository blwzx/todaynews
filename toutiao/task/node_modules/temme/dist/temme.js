...
const msg = {
    ...
    invalidModifier(name) {
        return `${name} is not a valid modifier.`;
    },
    invalidProcedure(name) {
...
function makeNormalCssSelector(sections) {
    const result = [];
...
function isAttributeQualifier(qualifier) {
    return qualifier.type === 'attribute-qualifier';
}
function isCapture(x) {
    return (x != null && typeof x === 'object' && typeof x.name === 'string' && Array.isArray(x.filterList));
}
function last(arr) {
    return arr[arr.length - 1];
}

const addModifier = { name: 'add', args: [] };
const forceAddModifier = { name: 'forceAdd', args: [] };
class CaptureResult {
    constructor(filterDict, modifierDict) {
    ...
    forceAdd(capture, value) {
        this.exec(capture, value, forceAddModifier);
    }
    exec(capture, value, defaultModifier) {
        ...
        modifierFn(this, capture.name, this.applyFilterList(value, capture.filterList), ...modifier.args);
    }
    getResult() {
    ...
    applyFilterList(initValue, filterList) {
        return filterList.reduce((value, filter) => {
            if (filter.isArrayFilter) {
                ...
                return value.map((item) => this.applyFilter(item, filter));
            }
            else {
...
function text(result, node, capture) {
    result.add(capture, node.text());
}
function html(result, node, capture) {
    result.add(capture, node.html());
}
function node(result, node, capture) {
 ...
 * */
function find(result, node, ...args) {
    const invalidArgs = 'Invalid arguments received by match(...)';
    const s = node.text();
    if (args.length === 2) {
        const [before, after] = args;
        invariant((typeof before === 'string' && isCapture(after)) ||
            (isCapture(before) && typeof after === 'string'), invalidArgs);
        ...
        const [before, capture, after] = args;
...
function assign(result, node, capture, value) {
    result.forceAdd(capture, value);
}
const defaultProcedureDict = {
...
function defineProcedure(name, fn) {
    defaultProcedureDict[name] = fn;
}

const defaultFilterDict = {
    pack() {
...
function defineModifier(name, modifier) {
...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c4 = function(section, procedure) {
            return {
        ...
        peg$c6 = function(sections, arrayCapture, children) {
            return {
        ...
        peg$c7 = function(sections, procedure) {
            return {
              type: 'normal-selector',
              sections,
              procedure,
        ...
        peg$c14 = function(name, selectors) {
            return {
              type: 'snippet-define',
              name,
              selectors,
        ...
        peg$c16 = "filter",
        peg$c17 = peg$literalExpectation("filter", false),
        peg$c18 = function(name, argsPart, code) {
            return {
              type: 'filter-define',
              name,
              argsPart,
        ...
        peg$c19 = "modifier",
        peg$c20 = peg$literalExpectation("modifier", false),
        peg$c21 = function(name, argsPart, code) {
            return {
        ...
        peg$c22 = "procedure",
        peg$c23 = peg$literalExpectation("procedure", false),
        peg$c24 = function(name, argsPart, code) {
            return {
        ...
        peg$c29 = function(str) { return str },
        peg$c30 = function() { error('Unbalanced parenthesis.'); },
        peg$c31 = /^[()]/,
        peg$c32 = peg$classExpectation(["(", ")"], false, false),
        peg$c33 = function(capture, value) {
        ...
        peg$c50 = function(name, filterList, modifier) {
            return { name, filterList, modifier }
          },
        peg$c51 = function(captureKey) {
        ...
        peg$c66 = peg$otherExpectation("normal css selector"),
        peg$c67 = peg$otherExpectation("css-selector-section-seperator"),
        peg$c68 = peg$otherExpectation("section"),
        peg$c69 = function(c) { return c },
        peg$c70 = "*",
        peg$c71 = peg$literalExpectation("*", false),
        peg$c72 = function(combinator, element, qualifiers) {
            return {
        ...
        peg$c73 = function(combinator, qualifiers) {
            return {
              combinator: combinator || ' ',
              element: '*',
              qualifiers: flatten(qualifiers),
        ...
        peg$c74 = peg$otherExpectation("css-selector-qualifier"),
        peg$c75 = peg$otherExpectation("css-selector-id-qualifier"),
        peg$c76 = "#",
        ...
        peg$c79 = peg$otherExpectation("css-selector-class-qualifier"),
        peg$c80 = ".",
        peg$c81 = peg$literalExpectation(".", false),
        peg$c82 = function(className) {
            return {
              type: 'class-qualifier',
              className,
            }
          },
        peg$c83 = peg$otherExpectation("css-selector-attribute-qualifier"),
        peg$c84 = "[",
        peg$c85 = peg$literalExpectation("[", false),
        peg$c86 = function(head, part) { return part },
        peg$c87 = "]",
        peg$c88 = peg$literalExpectation("]", false),
        peg$c89 = function(head, tail) {
            return [head].concat(tail)
          },
        peg$c90 = peg$otherExpectation("css-selector-attribute-qualifier-part"),
        peg$c91 = function(attribute, operator, value) {
            return {
        ...
        peg$c93 = peg$otherExpectation("css-selector-pseudo-qualifier"),
        peg$c94 = ":",
        peg$c95 = peg$literalExpectation(":", false),
        peg$c96 = /^[^)]/,
        peg$c97 = peg$classExpectation([")"], true, false),
        peg$c98 = function(name, content) {
            return {
        ...
        peg$c100 = function(detail) {
            return detail
          },
        peg$c101 = function(assignment) {
            return {
              name: ASSIGN_PROCEDURE_NAME,
              args: [assignment.capture, assignment.value],
            }
          },
        peg$c102 = function(capture) {
            return {
        ...
        peg$c104 = function(name, head, tail) {
            return {
              name,
        ...
        peg$c107 = function(filterList, modifier) {
            return { name: DEFAULT_CAPTURE_KEY, filterList, modifier }
          },
        peg$c108 = "-",
        peg$c109 = peg$literalExpectation("-", false),
        peg$c110 = /^[_a-z]/i,
        peg$c111 = peg$classExpectation(["_", ["a", "z"]], false, true),
        peg$c112 = /^[_a-z0-9\-]/i,
        peg$c113 = peg$classExpectation(["_", ["a", "z"], ["0", "9"], "-"], false, true),
        peg$c114 = /^[\x80-\uFFFF]/,
        peg$c115 = peg$classExpectation([["\x80", "\uFFFF"]], false, false),
        peg$c116 = peg$otherExpectation("identifier"),
        peg$c117 = function(head, tail) {
            return head + tail.join('')
          },
        peg$c118 = function() { return null },
        ...
        peg$c124 = function(sign, literal) {
            if (sign === '-') {
              return -literal
            } else {
              return literal
        ...
        peg$c125 = "0x",
        peg$c126 = peg$literalExpectation("0x", true),
        peg$c127 = function(digits) {
            return Number(text())
          },
        peg$c128 = "0b",
        peg$c129 = peg$literalExpectation("0b", true),
        peg$c130 = /^[01]/,
        peg$c131 = peg$classExpectation(["0", "1"], false, false),
        peg$c132 = function() {
            return Number(text())
          },
        peg$c133 = "0",
        peg$c134 = peg$literalExpectation("0", false),
        peg$c135 = peg$otherExpectation("regular expression"),
        peg$c136 = "/",
        peg$c137 = peg$literalExpectation("/", false),
        peg$c138 = function(pattern, flags) {
            try {
        ...
        peg$c171 = "\x0B",
        peg$c172 = peg$literalExpectation("\x0B", false),
        peg$c173 = "\f",
        peg$c174 = peg$literalExpectation("\f", false),
        peg$c175 = " ",
        peg$c176 = peg$literalExpectation(" ", false),
        peg$c177 = "\xA0",
        peg$c178 = peg$literalExpectation("\xA0", false),
        peg$c179 = "\uFEFF",
        ...
        peg$c194 = /^[1-9]/,
        peg$c195 = peg$classExpectation([["1", "9"]], false, false),
        peg$c196 = /^[0-9a-f]/i,
        ...
        peg$c223 = peg$otherExpectation("code block"),
        peg$c224 = function(code) { return code },
        peg$c225 = function() { error("Unbalanced brace."); },
        peg$c226 = /^[{}]/,
        ...
        peg$c233 = peg$classExpectation(["\xAA", "\xBA", "\u01BB", ["\u01C0", "\u01C3"], "\u0294", ["\u05D0", "\u05EA"], ["\u05F0", "\u05F2"], ["\u0620", "\u063F"], ["\u0641", "\u064A"], ["\u066E", "\u066F"], ["\u0671", "\u06D3"], "\u06D5", ["\u06EE", "\u06EF"], ["\u06FA", "\u06FC"], "\u06FF", "\u0710", ["\u0712", "\u072F"], ["\u074D", "\u07A5"], "\u07B1", ["\u07CA", "\u07EA"], ["\u0800", "\u0815"], ["\u0840", "\u0858"], ["\u08A0", "\u08B4"], ["\u0904", "\u0939"], "\u093D", "\u0950", ["\u0958", "\u0961"], ["\u0972", "\u0980"], ["\u0985", "\u098C"], ["\u098F", "\u0990"], ["\u0993", "\u09A8"], ["\u09AA", "\u09B0"], "\u09B2", ["\u09B6", "\u09B9"], "\u09BD", "\u09CE", ["\u09DC", "\u09DD"], ["\u09DF", "\u09E1"], ["\u09F0", "\u09F1"], ["\u0A05", "\u0A0A"], ["\u0A0F", "\u0A10"], ["\u0A13", "\u0A28"], ["\u0A2A", "\u0A30"], ["\u0A32", "\u0A33"], ["\u0A35", "\u0A36"], ["\u0A38", "\u0A39"], ["\u0A59", "\u0A5C"], "\u0A5E", ["\u0A72", "\u0A74"], ["\u0A85", "\u0A8D"], ["\u0A8F", "\u0A91"], ["\u0A93", "\u0AA8"], ["\u0AAA", "\u0AB0"], ["\u0AB2", "\u0AB3"], ["\u0AB5", "\u0AB9"], "\u0ABD", "\u0AD0", ["\u0AE0", "\u0AE1"], "\u0AF9", ["\u0B05", "\u0B0C"], ["\u0B0F", "\u0B10"], ["\u0B13", "\u0B28"], ["\u0B2A", "\u0B30"], ["\u0B32", "\u0B33"], ["\u0B35", "\u0B39"], "\u0B3D", ["\u0B5C", "\u0B5D"], ["\u0B5F", "\u0B61"], "\u0B71", "\u0B83", ["\u0B85", "\u0B8A"], ["\u0B8E", "\u0B90"], ["\u0B92", "\u0B95"], ["\u0B99", "\u0B9A"], "\u0B9C", ["\u0B9E", "\u0B9F"], ["\u0BA3", "\u0BA4"], ["\u0BA8", "\u0BAA"], ["\u0BAE", "\u0BB9"], "\u0BD0", ["\u0C05", "\u0C0C"], ["\u0C0E", "\u0C10"], ["\u0C12", "\u0C28"], ["\u0C2A", "\u0C39"], "\u0C3D", ["\u0C58", "\u0C5A"], ["\u0C60", "\u0C61"], ["\u0C85", "\u0C8C"], ["\u0C8E", "\u0C90"], ["\u0C92", "\u0CA8"], ["\u0CAA", "\
\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCC\u0BD7\u0C01-\u0C03\u0C41-\u0C44\u0C82-\u0C83\u0CBE\u0CC0-\u0CC4\u0CC7-\u0CC8\u0CCA-\u0CCB\u0CD5-\u0CD6\u0D02-\u0D03\u0D3E-\u0D40\u0D46-\u0D48\u0D4A-\u0D4C\u0D57\u0D82-\u0D83\u0DCF-\u0DD1\u0DD8-\u0DDF\u0DF2-\u0DF3\u0F3E-\u0F3F\u0F7F\u102B-\u102C\u1031\u1038\u103B-\u103C\u1056-\u1057\u1062-\u1064\u1067-\u106D\u1083-\u1084\u1087-\u108C\u108F\u109A-\u109C\u17B6\u17BE-\u17C5\u17C7-\u17C8\u1923-\u1926\u1929-\u192B\u1930-\u1931\u1933-\u1938\u1A19-\u1A1A\u1A55\u1A57\u1A61\u1A63-\u1A64\u1A6D-\u1A72\u1B04\u1B35\u1B3B\u1B3D-\u1B41\u1B43-\u1B44\u1B82\u1BA1\u1BA6-\u1BA7\u1BAA\u1BE7\u1BEA-\u1BEC\u1BEE\u1BF2-\u1BF3\u1C24-\u1C2B\u1C34-\u1C35\u1CE1\u1CF2-\u1CF3\u302E-\u302F\uA823-\uA824\uA827\uA880-\uA881\uA8B4-\uA8C3\uA952-\uA953\uA983\uA9B4-\uA9B5\uA9BA-\uA9BB\uA9BD-\uA9C0\uAA2F-\uAA30\uAA33-\uAA34\uAA4D\uAA7B\uAA7D\uAAEB\uAAEE-\uAAEF\uAAF5\uABE3-\uABE4\uABE6-\uABE7\uABE9-\uABEA\uABEC]/,
        ...
        peg$c254 = "true",
        peg$c255 = peg$literalExpectation("true", false),
...
const temmeParser = parser;
function temme(html, selector, extraFilters = {}, extraModifiers = {}, extraProcedures = {}) {
    let $;
    ...
    const filterDict = Object.assign({}, defaultFilterDict, extraFilters);
    const modifierDict = Object.assign({}, defaultModifierDict, extraModifiers);
    const procedureDict = Object.assign({}, defaultProcedureDict, extraProcedures);
        ...
        for (const selector of expandSnippets(selectorArray)) {
            if (selector.type === 'normal-selector') {
                ...
                if (selector.arrayCapture) {
                    result.add(selector.arrayCapture, subCheerio.toArray().map(sub => helper($(sub), selector.children).getResult()));
                }
            }
    ...
    function expandSnippets(selectorArray, expanded = []) {
        const result = [];
        for (const selector of selectorArray) {
    ...
    function capture(result, node, selector) {
...
exports.msg = msg;
exports.checkRootSelector = checkRootSelector;
exports.checkChild = checkChild;
exports.DEFAULT_CAPTURE_KEY = DEFAULT_CAPTURE_KEY;
exports.DEFAULT_PROCEDURE_NAME = DEFAULT_PROCEDURE_NAME;
exports.ASSIGN_PROCEDURE_NAME = ASSIGN_PROCEDURE_NAME;
exports.UNIVERSAL_SELECTOR = UNIVERSAL_SELECTOR;
exports.defaultProcedureDict = defaultProcedureDict;
exports.defineProcedure = defineProcedure;
exports.defaultFilterDict = defaultFilterDict;
exports.defineFilter = defineFilter;
exports.defaultModifierDict = defaultModifierDict;
exports.defineModifier = defineModifier;
exports.temmeParser = temmeParser;
exports.makeNormalCssSelector = makeNormalCssSelector;
exports.isEmptyObject = isEmptyObject;
exports.isCheerioStatic = isCheerioStatic;
exports.isAttributeQualifier = isAttributeQualifier;
